...
public class FrameDesJsUtil {
    public FrameDesJsUtil() {
    }
    /*public static void main(String[] args) {
        FrameDesJsUtil desObj = new FrameDesJsUtil();
        String key1 = "login";
        String key2 = null;
        String key3 = null;
        String data = "admin";
        String str = desObj.enc(data, key1, key2, key3);
        System.out.println(str);
        String dec = desObj.dec(str, key1, key2, key3);
     ...
     * DES加密
     */
    public String enc(String data, String firstKey, String secondKey,
            String thirdKey) {
    ...
    public String dec(String data, String firstKey, String secondKey,
            String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
